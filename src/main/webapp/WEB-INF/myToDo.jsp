...
<%@ page import="com.example.mytodo.model.Status" %>
<html lang="en">
<head>
    <title>TODO</title>
        ...
        <div class="col col-11 mx-auto">
            <div class="row bg-white rounded shadow-sm p-2 add-todo-wrapper align-items-center justify-content-center">
                <form action="/addToDo" method="post">
                    ...
                    <%--                            set</label>--%>
                    <%--                        <input type="date" placeholder="date" name="finishDate"--%>
        ...
        <div class="col mx-auto">
            <div class="row px-3 align-items-center todo-item rounded">
                <div class="col-auto m-1 p-0 d-flex align-items-center">
                    <h2 class="m-0 p-0">
                        <a href="/changeStatus?id=<%=toDo.getId()%>">
                            <i<%if (toDo.getStatus() == Status.NEW) {%>
                                    class="fa fa-square-o text-primary btn m-0 p-0"<%} else {%>
                ...
                <div class="col-auto m-1 p-0 px-3">
                    <div class="row">
                        <div class="col-auto d-flex align-items-center rounded bg-white border border-warning">
                            ...
                            <h6 class="text my-2 pr-2"><%=toDo.getFinisheDate()%>
                            </h6>
                        </div>
                    </div>
                </div>
